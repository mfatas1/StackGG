...
/** First fetch can take ~10s (Riot backfill) — skeleton tiles, never a spinner. */
export default function Loading() {
  return (
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6">
      ...
      <p className="text-center text-2xs text-ink-faint">Fetching match history from Riot…</p>
    </div>
  );
}
